    ...
    */
    ...
    /* Lets determine if circle 3 intersects at either of the above intersection points. */
        ...
        if(Math.abs(d1 - r2) < EPSILON) {
            System.out.println("INTERSECTION1 Circle1 AND Circle2 AND Circle3: (" + intersectionPoint1_x + "," + intersectionPoint1_y + ")");
            this.x = intersectionPoint1_x;
            this.y = intersectionPoint1_y;
        }
        else if(Math.abs(d2 - r2) < EPSILON) {
            System.out.println("INTERSECTION2 Circle1 AND Circle2 AND Circle3: (" + intersectionPoint2_x + "," + intersectionPoint2_y + ")"); //here was an error
            this.x = intersectionPoint2_x;
            this.y = intersectionPoint2_y;
        }
        else {
